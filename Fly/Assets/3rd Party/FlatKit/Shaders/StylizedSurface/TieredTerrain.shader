...
// #endif
        ...
        float3 baseShadedColours[maxLayerCount];
        float baseShadingSizes[maxLayerCount];
        float baseShadowEdges[maxLayerCount];
        float baselocalizedShading[maxLayerCount];

        float3 extraShadedColours[maxLayerCount];
        float extraShadingSizes[maxLayerCount];
        float extraShadowEdges[maxLayerCount];
        float extralocalizedShading[maxLayerCount];

        float3 specularColours[maxLayerCount];
        float specularShadingSizes[maxLayerCount];
        float specularShadowEdges[maxLayerCount];

        float3 rimColours[maxLayerCount];
        float rimLightAligns[maxLayerCount];
        float rimShadingSizes[maxLayerCount];
        float rimShadowEdges[maxLayerCount];
